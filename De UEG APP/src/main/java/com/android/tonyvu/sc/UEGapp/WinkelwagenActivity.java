...
import com.android.tonyvu.sc.UEGapp.adapter.CartItemAdapter;
import com.android.tonyvu.sc.UEGapp.model.CartItem;
import com.android.tonyvu.sc.UEGapp.model.Product;
import com.android.tonyvu.sc.model.Cart;
import com.android.tonyvu.sc.model.Saleable;
import com.android.tonyvu.sc.util.CartHelper;

public class WinkelwagenActivity extends AppCompatActivity {
    private static final String TAG = "WinkelwagenActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bClear.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d(TAG, "Winkelwagen leegmaken");
                cart.clear();
                cartItemAdapter.updateCartItems(getCartItems(cart));
        ...
        bShop.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WinkelwagenActivity.this, MainActivity.class);
    ...
    private List<CartItem> getCartItems(Cart cart) {
        ...
        Log.d(TAG, "Huidige winkelwagen: " + cart);
        ...
        Log.d(TAG, "Winkelwagen productenlijst " + cartItems);
        return cartItems;
    }
}
